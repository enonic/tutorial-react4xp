...
Content types are nice, but letting the editor compose his on pages is even better.

This is where the real power of React4XP comes into play, by defining a page, editors may drag'n drop cms components into the page!

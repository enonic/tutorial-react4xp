...
The second included helper, *_<<#guillotine_request_helper, headless/guillotineRequest.es6>>_*, is a `fetch` wrapper to simplify guillotine requests at the frontend. We'll take a look at that later.

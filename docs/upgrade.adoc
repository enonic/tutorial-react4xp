...
* Make sure they are placed in <projectDir>/src/main/resources/react4xpNashornPolyfills.es6

=== If you have webpack overrides

* Make sure they are placed in <projectDir>/webpack.config.react4xp.js

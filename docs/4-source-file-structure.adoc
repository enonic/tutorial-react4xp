...
These strings are called *jsxPaths* in react4xp, and they can be used directly in controllers as the _entry_ argument. For example in the <<3-pages-parts-and-regions#color_part_controller, _color_ Part controller>> from before:

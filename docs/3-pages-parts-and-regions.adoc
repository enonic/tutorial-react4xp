...
Before we move on to the XP Part, we need to bind this Page controller to the _my-content_ Content Type we just made, in the regular XP way: a Page Template.

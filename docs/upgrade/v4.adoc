...
This means we had to upgrade the Enonic XP version requirement to 7.12 (<<_gradle_properties>>)
...
The types for lib-explorer are available via npm:

* https://www.npmjs.com/package/@enonic-types/lib-react4xp

See the <<_tsconfig_json>> section below on how to set it up.

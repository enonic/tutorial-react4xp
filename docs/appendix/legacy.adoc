...
The folder structure of your React4XP application should look similar to this:
...
<5> default page component
<6> Global styles
<7> Main React component
<8> link:./controller#site-mapping[Site descriptor^]
<9> Folder for descriptor
<10> Component descriptor XML
<11> Optionally place CMS schemas here
<12> Boostrapping controller
<13> TypeScript types (optional)

...
One of these is `Person`.
From Content Studio, you may find and list persons.
...
[source,TypeScript]
----
include::{snippet}Rendering-basics/PersonProcessor.ts[]
----
+
...
[source,TypeScript]
----
include::{snippet}Rendering-basics/Person.tsx[]
----
+
./src/main/resources/react4xp/components/content/Person.module.css (CSS module)
[source,CSS]
----
include::{snippet}Rendering-basics/Person.module.css[]
----
...
You are on a roll, next - lets look into <<app-layout#, app layout>>.

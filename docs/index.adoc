...
Now you're ready to get started with the *example lessons*.
...
The first three chapters are the *basic-level tutorial*. This is what you need to get started:
...
The next three present a few more *advanced usages*:
...
Conceptual overviews and optimization:

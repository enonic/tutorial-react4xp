...
If you need to change/expand this setup, simply place a custom `somethingElse.js` in your project folder.
...
`somethingElse.js` can follow the same shape, but the exported function can also take *a second `config` argument:*

...
What happened to the FactBox dataProcessor? Macros automatically get configuration values passed to the React component via the `children` field.

TIP: To create a macro dataProcessor, register it using `.addMacro` instead of `.addPage` in your dataFetcher.

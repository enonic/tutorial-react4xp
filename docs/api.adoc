...
Put _react4xp.properties_ at the root of your XP project. A template can be copied from link:https://github.com/enonic/enonic-react4xp/blob/master/react4xp.properties[here], or from _node_modules/react4xp/react4xp.properties_ after installing the react4xp NPM package.

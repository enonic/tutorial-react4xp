...
React4xp is an XP library (with a companion gradle build config) that:
...
TIP: You don't need to know the following structure by heart to get started. *Just put your JSX source files under `react4xp/_entries/` or under `site/`, and you're ready to get started: build and run.*

...
=== 1: Hello React (entries, server-side rendering by default)
...
=== 2: Client-side rendering (parameters, jsxPath, target body, editorial props)
...
=== 3: Custom flow (React4xp objects syntax, manual control, the _entries folder)
...
=== 4: Chaining (multiple entries, nesting, chunks)

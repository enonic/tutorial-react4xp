...
As this is a breaking change you need to follow the recommended link:./recommended.adoc#page-layout[guide^] for migrating pages and layouts as these are dependent on the component registry.
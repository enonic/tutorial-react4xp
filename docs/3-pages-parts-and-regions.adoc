= React4xp, lesson 3: XP content studio, and pages, parts, regions and content
:toc: right
:toclevels: 2
:imagesdir: media/
...
Moving on from here, we'll take a look at more advanced (and useful!) ways to use react4xp.

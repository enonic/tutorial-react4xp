...
Persistent code cache is switched off by default, since it was occasionally error-prone and didn't improve performance all that much. Your mileage may vary, but use with care.

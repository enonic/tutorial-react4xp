...
TIP: Visit the <<appendix/app-controller#, app controller appendix>>  to learn more about how React4XP is bootstrapped.
...
[source,TypeScript]
----
include::../src/main/resources/react4xp/componentRegistry.ts[]
----

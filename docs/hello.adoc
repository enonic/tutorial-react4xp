...
+
. Add your brand new "React4XP" application to the site. After saving, the preview will refresh, to reveal something like this:
+
image:hello.png[title="React4XP starter page", width=1440px]

...
-> site/components/helloProcessor.ts (props for the Hello component)
...
The responsiblity of HelloProcessor is to produce the props required by a component.
A processor may also intercept the request, for instance by producing a redirect.

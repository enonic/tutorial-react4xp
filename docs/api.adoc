...
Beyond that, this document is super detailed. It's probably fine to *focus on the code*, and just use the text for context and a closer look.
====
...
Now you're ready to get started with the *example lessons* - 3 basic chapters and 3 for advanced usage:

...
Now let's add a simple Part to drop into the Region: _site/parts/color/_ .
...
Time to get this displayed and see it all in action! Again, just XP routing: creating a _my-content_ item, and since the Template makes it show up ready with a _Default_ Page controller and Region, we can just drop our new part into it.and

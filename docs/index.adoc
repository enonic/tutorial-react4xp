...
. Finally, React4xp can be *used outside of the page/part flow*, even without making XP controllers if needed. A few services are exposed in runtime - endpoints where a client can request runnable compiled code:
